...
// mysqlRouter.post(
//   '/addRow',
//   mysqlController.mysqlAddNewRow,
//   (_req: Request, res: Response) => {
...
// mysqlRouter.patch(
//   '/updateRow',
//   mysqlController.mysqlUpdateRow,
//   (_req: Request, res: Response) => {
//     return res.sendStatus(200);
//   }
// );
...
// mysqlRouter.delete(
//   '/deleteRow',
//   mysqlController.mysqlDeleteRow,
//   (_req: Request, res: Response) => {
//     return res.sendStatus(200);
//   }
// );
...
// mysqlRouter.post(
//   '/addColumn',
//   mysqlController.mysqlAddNewColumn,
//   (_req: Request, res: Response) => {
...
// mysqlRouter.patch(
//   '/updateColumn',
//   mysqlController.mysqlUpdateColumn,
//   (_req: Request, res: Response) => {
//     return res.sendStatus(200);
//   }
// );
...
// mysqlRouter.delete(
//   '/deleteColumn',
//   mysqlController.mysqlDeleteColumn,
//   (_req: Request, res: Response) => {
//     return res.sendStatus(200);
//   }
// );
...
// mysqlRouter.post(
//   '/saveNewTable',
//   mysqlController.mysqlAddNewTable,
//   (_req: Request, res: Response) => {
...
// mysqlRouter.delete(
//   '/deleteTable',
//   mysqlController.mysqlDeleteTable,
//   mysqlController.mysqlQuery,
//   (_req: Request, res: Response) => {
//     return res.status(200).json(res.locals);
//   }
// );
...
// mysqlRouter.put(
//   '/addForeignKey',
//   mysqlController.mysqlAddForeignKey,
//   (_req: Request, res: Response) => {
//     return res.sendStatus(200);
//   }
// );
...
// mysqlRouter.delete(
//   '/removeForeignKey',
//   mysqlController.mysqlRemoveForeignKey,
//   (_req: Request, res: Response) => {
